...
model_roberta_direct = AutoModelForSequenceClassification.from_pretrained("dipudl/ai-human-classification-hc3-wiki-recleaned-dataset-max-length-512")
tokenizer_roberta_direct = AutoTokenizer.from_pretrained("dipudl/ai-human-classification-hc3-wiki-recleaned-dataset-max-length-512")
...
model_roberta = AutoModelForSequenceClassification.from_pretrained("dipudl/hc3-wiki-domain-classification-roberta")
tokenizer_roberta = AutoTokenizer.from_pretrained("dipudl/hc3-wiki-domain-classification-roberta")
